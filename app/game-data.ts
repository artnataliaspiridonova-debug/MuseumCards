...
export const rounds: AdventureRound[] = [
  {
    ...
    cards: [
      ...
      card("find-6", "Найдите живописную работу, в которой хорошо видны мазки или движение кисти", "Find a painting where the brushstrokes or movement of the brush are clearly visible", "Представьте и опишите движения руки художника.", "Imagine and describe how the artist's hand moved."),
  ...
  },
  {
    ...
    cards: [
      ...
      card("observe-3", "Если бы вы могли войти внутрь произведения, где бы вы оказались?", "If you could step into this artwork, where would you find yourself?", "Где находился бы вход и куда бы вы попали?", "Where would the entrance be, and where would it lead?"),
      ...
      card("observe-5", "Проведите перед произведением одну минуту", "Spend one minute with the artwork", "Какие детали вы заметили только спустя некоторое время?", "What did you notice only after looking for a while?"),
      ...
      card("observe-7", "Что происходит на заднем плане или по краям произведения?", "What is happening in the background or around the edges?", "Какую историю рассказывают небольшие детали, формы или цвета?", "What story do the small details, shapes or colors tell?"),
      card("observe-8", "Как вы думаете, что происходит внутри этой работы?", "What do you think is happening inside this artwork?", "Опишите это одним предложением.", "Describe it in one sentence."),
  ...
  },
  {
    ...
    soft: "#FFF0E7",
    cards: [
      card("imagine-1", "Представьте, что вы оказались внутри произведения", "Imagine that you have stepped inside the artwork", "Какой запах лучше всего передаёт атмосферу этого места?", "What scent best captures the atmosphere of this place?"),
  ...
  },
  {
    ...
    cards: [
      ...
      card("create-3", "Добавьте в произведение нового героя, предмет или форму", "Add a new character, object or shape to this artwork", "Нарисуйте или опишите то, что вы добавили.", "Draw or describe what you added."),
      ...
      card("create-7", "Добавьте произведению реплику, как в комиксе", "Give the artwork a speech bubble", "Что могло бы сказать само произведение или один из его героев?", "What might the artwork—or one of its characters—say?"),
      card("create-8", "Создайте короткий рассказ на основе произведения", "Create a short story inspired by the artwork", "Запишите его или расскажите вслух.", "Write it down or tell it aloud."),
      ...
      card("create-10", "Повторите движение линии, позу или жест", "Recreate a line, movement, pose or gesture from the artwork", "Передайте его движением руки или всего тела.", "Use your hand or your whole body."),
    ],
  },
  {
    id: "challenge",
    ...
    soft: "#FCE9EF",
    cards: [
      card("challenge-1", "Представьте себя фотографом", "Imagine that you are a photographer", "Придумайте кадр по мотивам произведения. Если правила музея разрешают, сделайте снимок; если нет — опишите его.", "Imagine a photograph inspired by the artwork. Take it if photography is allowed; otherwise, describe it."),
      ...
      card("challenge-5", "Представьте себя коллекционером", "Imagine that you are a collector", "Какой была бы ваша коллекция и стало бы это произведение её частью?", "What would your collection be like, and would this artwork belong in it?"),
      card("challenge-6", "Представьте, что вы продаёте это произведение на аукционе", "Imagine that you are selling this artwork at an auction", "Объясните, почему оно заслуживает высокой цены.", "Explain why it deserves a high price."),
      ...
      card("challenge-8", "Представьте себя автором произведения", "Imagine you are the artist. How would you describe this artwork in an interview?", "Расскажите о своей работе журналистам в трёх предложениях.", "Tell a journalist about your work in three sentences."),
